...
<div class="col-lg-2">
    <div class="main-container d-flex">
        <div class="sidebar" id="sidenav">
            <div class="header-box pb-4">
                
                <button class="btn d-md-none d-block close-btn px-1 py-0 text-white"><i class="fa-solid fa-bars-staggered"></i></button>
            </div>
            <ul class="list-unstyled px-3 py-4">
                <li>
                <a class="nav-link active default" aria-current="page" href="lessons.php?pId=myprofile" class="text-decoration-none"
                >My Profile</a>
                </li>
                        ...
                        <?php 
                            ...
                            while( $data =  mysqli_fetch_array($res)){
                                ...
                                echo <<<data
                                 ...
                                 <li><a href="lessons.php?cId=$cId" class="dropdown-item pl-4 p-2">$name</a></li>
                                data;
                            ?>
                            <?php  }  ?>
                    </ul>
   ...
   <table class="table  table-hover table-striped">
     ...
     <tbody>
       <tr>
         ...
         <td><input type="button" name="view" value="view" id="<?php echo $row["lesson_id"]; ?>" class="btn btn-info btn-xs view_data" /></td> 
